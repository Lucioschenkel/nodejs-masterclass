...
helpers.sendTwilioSms = function(phone, msg, callback) {
  ...
  if (phone && msg) {
    ...
    const req = https.request(requestDetails, function(res) {
      ...
      // Callback successfuly if que request when through
...
helpers.interpolate = function(str, data) {
  ...
  // Add the template globals to the data object, pre-pending their key name with "global"
  ...
  // For each key in the data object, insert its value into the string at the correspondent place
  for (let key in data) {
...
// Gets the content of a static public asset
